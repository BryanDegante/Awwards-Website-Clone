		...
		<section id="features" className="bg-black pb-52">
			<div className="container mx-auto px-3 md:px-10">
				<div className="px-5 py-32">
					<p className="font-circular-web text-larg text-blue-50">
				...
				<BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
					<BentoCard
						...
						description="A cross-plateform metagame app, turning your activites across Web2 and Web3 games into a rewarding adventure. "
					/>
				</BentoTilt>
				<div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
					<BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
						<BentoCard
							...
							description="An anime and gaming Inspried NFT collection - the IP primed for expansion"
						/>
					</BentoTilt>
